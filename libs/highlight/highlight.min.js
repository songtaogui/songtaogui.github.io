...
}]}}})();hljs.registerLanguage("wasm",e)})();/*! `julia` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{
const r="[A-Za-z_\\u00A1-\\uFFFF][A-Za-z_0-9\\u00A1-\\uFFFF]*",t={$pattern:r,
keyword:["baremodule","begin","break","catch","ccall","const","continue","do","else","elseif","end","export","false","finally","for","function","global","if","import","in","isa","let","local","macro","module","quote","return","true","try","using","where","while","julia"],
...
}],a.contains=n.contains,n}})();hljs.registerLanguage("julia",e)})();/*! `c` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("markdown",e)})();/*! `julia-repl` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("julia-repl",a)})();/*! `csharp` grammar compiled for Highlight.js 11.6.0 */
...
contains:[{begin:/\\./}]}]}}})();hljs.registerLanguage("r",e)})();/*! `awk` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("awk",e)})();/*! `shell` grammar compiled for Highlight.js 11.6.0 */
