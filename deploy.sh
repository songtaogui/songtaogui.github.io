...
OPTIONS: ([R]:required  [O]:optional)
    ...
    -b, --builder                       deploy the builder instead of the blog site, 
                                        default: only deploy the blog repos (__site dir)
    --all                               deploy both the builder and the blog repos
...
if [ "$blog" == "TRUE" ];then
    ...
    gst_rcd "Encrypting private files ..."
    ...
    gst_rcd "Deploy on github with commit [ $commit ] ..."
